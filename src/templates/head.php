...
<head>
    ...
    <link href="<?php echo get_template_directory_uri(); ?>/assets/css/main.css<?php echo '?v=' . filemtime( get_stylesheet_directory() . '/assets/css/main.css'); ?>" rel="stylesheet">
	...
	<script src="<?php echo get_template_directory_uri(); ?>/assets/js/vendor/modernizr.js<?php echo '?v=' . filemtime( get_stylesheet_directory() . '/assets/js/vendor/modernizr.js'); ?>"></script>
	<!--[if lt IE 9]>
